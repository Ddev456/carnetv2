...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex flex-col flex-wrap sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]: [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
